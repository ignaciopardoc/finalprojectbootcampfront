    ...
    return (
      <Fragment>
        ...
        <div className="row d-flex justify-content-center mt-3">
            <button className={`mr-5 btn ${this.state.selectedOptionHome === 0 ? `btn-success` : `btn-light`}`} onClick={() => this.setState({selectedOptionHome: 0})}>Mapa</button>
            <button className={`ml-5 btn ${this.state.selectedOptionHome === 1 ? `btn-success` : `btn-light`}`} onClick={() => this.setState({selectedOptionHome: 1})}>Próximos eventos</button>
        </div>
